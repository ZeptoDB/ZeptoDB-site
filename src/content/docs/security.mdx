...
For detailed configuration, see the [Security Operations Guide](/ZeptoDB-site/api/security_operations_guide/) and [SSO Integration Guide](/ZeptoDB-site/api/sso_integration_guide/).
